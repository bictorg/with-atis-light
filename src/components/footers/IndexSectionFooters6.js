...
export default function IndexSectionFooters6() {
  ...
  <div className="container px-4 mx-auto">
    <div className="pb-20 border-b">
      <div className="flex flex-wrap -m-8">
        <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
          <h3 className="mb-6 font-semibold leading-normal">Studymark</h3>
          <ul>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">App Info</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Join Us</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">News</a></li>
            <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Insights</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
          <h3 className="mb-6 font-semibold leading-normal">Explore</h3>
          <ul>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Sign In</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Sign Up</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Create List</a></li>
            <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Reach Out</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
          <h3 className="mb-6 font-semibold leading-normal">Policies</h3>
          <ul>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Conditions</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Our Story</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Our Team</a></li>
            <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Data Protection</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-2/12 p-8">
          <h3 className="mb-6 font-semibold leading-normal">Helpful Links</h3>
          <ul>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Articles</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Offerings</a></li>
            <li className="mb-3.5"><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Our Solution</a></li>
            <li><a className="text-gray-600 hover:text-gray-700 font-medium leading-relaxed" href="#">Costs</a></li>
          </ul>
        </div>
        <div className="w-full sm:w-1/2 lg:w-4/12 p-8">
          <div className="lg:max-w-sm">
            <h3 className="mb-6 font-semibold leading-normal">Get Updates</h3>
            <p className="mb-5 font-sans text-gray-600 leading-relaxed">Discover more about student life enhancement.</p>
            <div className="mb-3 xl:pl-6 inline-block md:max-w-xl w-full overflow-hidden border border-gray-300 rounded-xl focus-within:ring focus-within:ring-indigo-300">
              <div className="flex flex-wrap items-center">
                ...
                <div className="w-full xl:w-auto">
                  <div className="block">
                    <button className="py-4 px-8 w-full text-white font-semibold border border-indigo-700 focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200" type="button">Get Updates</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div className="flex flex-wrap justify-between items-center py-6 -m-4">
      ...
      <div className="w-auto p-4">
        <p className="text-sm text-gray-600 font-medium">© 2022 Studymark. All Rights Reserved</p>
      </div>
      <div className="w-auto p-4">
